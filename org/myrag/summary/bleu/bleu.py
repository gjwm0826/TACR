...
from org.myrag.summary.bleu.nmt_bleu import compute_bleu  # From: https://github.com/tensorflow/nmt/blob/master/nmt/scripts/bleu.py
from org.myrag.summary.bleu.tokenizer_13a import Tokenizer13a
...
class Bleu(evaluate.Metric):
    def _info(self):
        return evaluate.MetricInfo(
            ...
            codebase_urls=["https://kkgithub.com/tensorflow/nmt/blob/master/nmt/scripts/bleu.py"],
            reference_urls=[
